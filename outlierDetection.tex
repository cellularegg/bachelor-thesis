...
\hl{Methods to detect outliers are described in} \autoref{section:outlier-detection-approaches} \change{Lassen sich diese "outliers" algorithmisch erfassen/detektieren?}
\begin{figure}[h]
  \centering
