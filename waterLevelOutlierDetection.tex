...
\section{Manual Classification of Outliers}
...
% % {\scriptsize } Fuer kleiner schriftgroesse
...
\input{tables/36022-ie/36022-ie-7-number-summary-all.tex}
...
\autoref{figure:time-delta-histogram-36022-ie} Shows the histogram of the time difference, in hours, between each datapoint. The largest gap of data is 178 hours, which is about one week.
\begin{figure}[htp]
    \centering
...
% \todo{change average to harmonic mean?}
...
% \todo{Add values of Precision and Recall for each O.D. Method}
\subsubsection{Mean}
...
% f1 score: 0.7892049598832969
% precision: 0.7451790633608816
...
% \todo{think of explanation for that.}
