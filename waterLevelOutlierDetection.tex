...
\end{figure}
\todo{Correct reference of a image used 1:1?}
...
Calculating $\hat{x}_t$ using the mean for a pandas DataFrame is quite straightforward and is shown in \autoref{listing:mean-outlier-calculation}.
\begin{listing}
